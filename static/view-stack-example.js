...
$_mod.installed("view-stack-example$1.0.0", "view-stack", "5.0.0");
$_mod.main("/view-stack$5.0.0", "");
$_mod.installed("view-stack$5.0.0", "thataway", "2.1.2");
$_mod.main("/thataway$2.1.2", "");
$_mod.installed("thataway$2.1.2", "query-string", "4.2.2");
$_mod.main("/query-string$4.2.2", "");
$_mod.installed("query-string$4.2.2", "strict-uri-encode", "1.1.0");
$_mod.main("/strict-uri-encode$1.1.0", "");
$_mod.def("/strict-uri-encode$1.1.0/index", function(require, exports, module, __filename, __dirname) { 'use strict';
...
$_mod.installed("query-string$4.2.2", "object-assign", "4.1.0");
$_mod.main("/object-assign$4.1.0", "");
$_mod.def("/object-assign$4.1.0/index", function(require, exports, module, __filename, __dirname) { 'use strict';
...
$_mod.def("/query-string$4.2.2/index", function(require, exports, module, __filename, __dirname) { 'use strict';
var strictUriEncode = require('/strict-uri-encode$1.1.0/index'/*'strict-uri-encode'*/);
var objectAssign = require('/object-assign$4.1.0/index'/*'object-assign'*/);
...
$_mod.installed("thataway$2.1.2", "router-params", "2.0.2");
$_mod.main("/router-params$2.0.2", "");
$_mod.installed("router-params$2.0.2", "path-to-regexp", "1.5.3");
$_mod.main("/path-to-regexp$1.5.3", "");
$_mod.installed("path-to-regexp$1.5.3", "isarray", "0.0.1");
...
$_mod.def("/path-to-regexp$1.5.3/index", function(require, exports, module, __filename, __dirname) { var isarray = require('/isarray$0.0.1/index'/*'isarray'*/)
...
$_mod.def("/router-params$2.0.2/index", function(require, exports, module, __filename, __dirname) { var pathToRegexp = require('/path-to-regexp$1.5.3/index'/*'path-to-regexp'*/)
...
$_mod.def("/thataway$2.1.2/index", function(require, exports, module, __filename, __dirname) { var queryString = require('/query-string$4.2.2/index'/*'query-string'*/)
var routerParams = require('/router-params$2.0.2/index'/*'router-params'*/)
...
$_mod.installed("view-stack$5.0.0", "yo-yo", "1.2.2");
$_mod.main("/yo-yo$1.2.2", "");
$_mod.installed("yo-yo$1.2.2", "bel", "4.4.3");
$_mod.main("/bel$4.4.3", "");
$_mod.installed("bel$4.4.3", "global", "4.3.0");
$_mod.installed("global$4.3.0", "min-document", "2.18.1");
$_mod.main("/min-document$2.18.1", "");
$_mod.remap("/min-document$2.18.1/index", false);
$_mod.def("/global$4.3.0/document", function(require, exports, module, __filename, __dirname) { var topLevel = typeof global !== 'undefined' ? global :
...
$_mod.installed("bel$4.4.3", "hyperx", "2.0.4");
$_mod.main("/hyperx$2.0.4", "");
$_mod.installed("hyperx$2.0.4", "hyperscript-attribute-to-property", "1.0.0");
$_mod.main("/hyperscript-attribute-to-property$1.0.0", "");
$_mod.def("/hyperscript-attribute-to-property$1.0.0/index", function(require, exports, module, __filename, __dirname) { module.exports = attributeToProperty
...
$_mod.def("/hyperx$2.0.4/index", function(require, exports, module, __filename, __dirname) { var attrToProp = require('/hyperscript-attribute-to-property$1.0.0/index'/*'hyperscript-attribute-to-property'*/)
...
$_mod.installed("bel$4.4.3", "on-load", "3.2.0");
$_mod.main("/on-load$3.2.0", "");
$_mod.installed("on-load$3.2.0", "global", "4.3.0");
$_mod.def("/global$4.3.0/window", function(require, exports, module, __filename, __dirname) { if (typeof window !== "undefined") {
...
$_mod.def("/on-load$3.2.0/index", function(require, exports, module, __filename, __dirname) { /* global MutationObserver */
var document = require('/global$4.3.0/document'/*'global/document'*/)
var window = require('/global$4.3.0/window'/*'global/window'*/)
...
$_mod.def("/bel$4.4.3/index", function(require, exports, module, __filename, __dirname) { var document = require('/global$4.3.0/document'/*'global/document'*/)
var hyperx = require('/hyperx$2.0.4/index'/*'hyperx'*/)
var onload = require('/on-load$3.2.0/index'/*'on-load'*/)
...
$_mod.installed("yo-yo$1.2.2", "morphdom", "1.4.6");
...
$_mod.def("/yo-yo$1.2.2/update-events", function(require, exports, module, __filename, __dirname) { module.exports = [
...
$_mod.def("/yo-yo$1.2.2/index", function(require, exports, module, __filename, __dirname) { var bel = require('/bel$4.4.3/index'/*'bel'*/) // turns template tag into DOM elements
var morphdom = require('/morphdom$1.4.6/lib/index'/*'morphdom'*/) // efficiently diffs + morphs two DOM elements
var defaultEvents = require('/yo-yo$1.2.2/update-events'/*'./update-events.js'*/) // default events to be copied when dom elements update
...
$_mod.def("/view-stack$5.0.0/index", function(require, exports, module, __filename, __dirname) { var router = require('/thataway$2.1.2/index'/*'thataway'*/)()
var yo = require('/yo-yo$1.2.2/index'/*'yo-yo'*/)
...
$_mod.installed("view-stack-example$1.0.0", "yo-yo", "1.2.1");
$_mod.main("/yo-yo$1.2.1", "");
$_mod.installed("yo-yo$1.2.1", "bel", "4.3.2");
$_mod.main("/bel$4.3.2", "");
$_mod.installed("bel$4.3.2", "global", "4.3.0");
$_mod.installed("global$4.3.0", "min-document", "2.18.0");
$_mod.main("/min-document$2.18.0", "");
$_mod.remap("/min-document$2.18.0/index", false);
$_mod.installed("bel$4.3.2", "hyperx", "2.0.4");
$_mod.def("/bel$4.3.2/index", function(require, exports, module, __filename, __dirname) { var document = require('/global$4.3.0/document'/*'global/document'*/)
var hyperx = require('/hyperx$2.0.4/index'/*'hyperx'*/)
...
$_mod.installed("yo-yo$1.2.1", "morphdom", "1.4.3");
$_mod.main("/morphdom$1.4.3", "lib/index");
$_mod.def("/morphdom$1.4.3/lib/index", function(require, exports, module, __filename, __dirname) { // Create a range object for efficently rendering strings to elements.
var range;
...
$_mod.def("/yo-yo$1.2.1/update-events", function(require, exports, module, __filename, __dirname) { module.exports = [
  // attribute events (can be set with attributes)
  'onclick',
  'ondblclick',
  'onmousedown',
...
$_mod.def("/yo-yo$1.2.1/index", function(require, exports, module, __filename, __dirname) { var bel = require('/bel$4.3.2/index'/*'bel'*/) // turns template tag into DOM elements
var morphdom = require('/morphdom$1.4.3/lib/index'/*'morphdom'*/) // efficiently diffs + morphs two DOM elements
var defaultEvents = require('/yo-yo$1.2.1/update-events'/*'./update-events.js'*/) // default events to be copied when dom elements update
...
$_mod.def("/view-stack-example$1.0.0/components/button", function(require, exports, module, __filename, __dirname) { var yo = require('/yo-yo$1.2.1/index'/*'yo-yo'*/)
...
$_mod.def("/view-stack-example$1.0.0/screens/a", function(require, exports, module, __filename, __dirname) { var yo = require('/yo-yo$1.2.1/index'/*'yo-yo'*/)
var btn = require('/view-stack-example$1.0.0/components/button'/*'../components/button'*/)
...
$_mod.def("/view-stack-example$1.0.0/screens/b", function(require, exports, module, __filename, __dirname) { var yo = require('/yo-yo$1.2.1/index'/*'yo-yo'*/)
var btn = require('/view-stack-example$1.0.0/components/button'/*'../components/button'*/)
...
$_mod.def("/view-stack-example$1.0.0/screens/c", function(require, exports, module, __filename, __dirname) { var yo = require('/yo-yo$1.2.1/index'/*'yo-yo'*/)
var btn = require('/view-stack-example$1.0.0/components/button'/*'../components/button'*/)
...
$_mod.def("/view-stack-example$1.0.0/screens/d", function(require, exports, module, __filename, __dirname) { var yo = require('/yo-yo$1.2.1/index'/*'yo-yo'*/)
var btn = require('/view-stack-example$1.0.0/components/button'/*'../components/button'*/)
...
$_mod.def("/view-stack-example$1.0.0/routes", function(require, exports, module, __filename, __dirname) { module.exports = [
  {
    path: '/',
    data: {
      persist: true,
      layer: 'screens',
      callback: function() {
        return require('/view-stack-example$1.0.0/screens/a'/*'./screens/a'*/)
      }
    }
  }, {
    path: '/a',
    ...
    data: {
      ...
      layer: 'screens',
      callback: function() {
        return require('/view-stack-example$1.0.0/screens/b'/*'./screens/b'*/)
      }
    }
  }, {
    path: '/c',
    data: {
      layer: 'sheets',
      callback: function() {
        return require('/view-stack-example$1.0.0/screens/c'/*'./screens/c'*/)
      }
    }
  }, {
    path: '/d',
    data: {
      layer: 'modals',
      callback: function() {
        return require('/view-stack-example$1.0.0/screens/d'/*'./screens/d'*/)
      }
    }
  }
]
...
$_mod.run("/view-stack-example$1.0.0/index");
$_mod.def("/view-stack-example$1.0.0/index", function(require, exports, module, __filename, __dirname) { module.exports = function() {
var createViewStack = require('/view-stack$5.0.0/index'/*'view-stack'*/)
var routes = require('/view-stack-example$1.0.0/routes'/*'./routes'*/)
